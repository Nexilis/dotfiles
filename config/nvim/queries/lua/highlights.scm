; Workaround for Neovim 0.12.2 bug: Lua parser removed the "operator" field
; from binary_expression/unary_expression but bundled queries still reference it.
; Remove this file once Neovim ships a fix.
...
; Operators (fixed: match tokens directly instead of removed "operator" field)
(binary_expression
  ["+" "-" "*" "/" "//" "%" "^" ".." "==" "~=" "<" "<=" ">" ">=" "&" "|" "<<" ">>" "~"] @operator)
